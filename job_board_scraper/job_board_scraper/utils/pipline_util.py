...
def get_table_columns(table_name):
    ...
    if table_name == "greenhouse_job_departments":
        return (
            initial_columns
            + """, company_name, department_category, department_id, department_name)"""
        )
    elif table_name == "greenhouse_jobs_outline":
        return (
            initial_columns
            + """, department_ids, location, office_ids, opening_link, opening_title)"""
        )
    elif table_name == "lever_jobs_outline":
        return (
            initial_columns
            + """, company_name, department_names, location, opening_link, opening_title, workplace_type)"""
        )
    else:
...
def get_table_values(table_name, item):
    ...
    if table_name == "greenhouse_job_departments":
        return initial_percent_s + """, %s, %s, %s, %s)""", initial_values + [
        ...
        return initial_percent_s + """, %s, %s, %s, %s, %s)""", initial_values + [
        ...
        return initial_percent_s + """, %s, %s, %s, %s, %s, %s)""", initial_values + [
            finalize_value(item, "company_name"),
